...
```
cd existing_repo
git remote add origin https://git.tecoreng.com/TCE-90/registration_dashboard.git
git branch -M main
...
* [Set up project integrations](https://git.tecoreng.com/TCE-90/registration_dashboard/-/settings/integrations)
